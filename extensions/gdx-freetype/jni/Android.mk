...
LOCAL_CFLAGS := $(LOCAL_C_INCLUDES:%=-I%) -O2 -Wall -D__ANDROID__  -DFT2_BUILD_LIBRARY -Werror=return-type
LOCAL_CPPFLAGS := $(LOCAL_C_INCLUDES:%=-I%) -O2 -Wall -D__ANDROID__  -DFT2_BUILD_LIBRARY -Werror=return-type
LOCAL_LDLIBS := -lm
LOCAL_ARM_MODE  := arm
